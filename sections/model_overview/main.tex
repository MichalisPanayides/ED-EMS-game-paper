...
The problem studied is a 3-player normal form game.

 The players are:
  
 \begin{itemize}
 
      \item The decision makers of two queueing 
systems;
...
are blocked.   % TODO Depending on how this is described earlier, we might need a little more here (as to what we mean by "blocked")
...
behaviour. 
For example one approach is to use the threshold that maximises the probability that 
