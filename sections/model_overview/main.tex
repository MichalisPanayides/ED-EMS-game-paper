...
where \(W\) is the mean waiting time of all individuals, \(t\) is the time 
...
Using equations (\ref{eq:obj_queueing_systems}) and (\ref{eq:obj_distributor}) 
gives an imperfect information extensive form game. 
...
individuals will be blocked. Figure \ref{fig:imperfect_info_game} illustrates this. 
