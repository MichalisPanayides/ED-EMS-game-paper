...
expected delay.
In this paper, while giving some consideration to equilibrium behaviour,
...
Thus, the novelty of this paper in a way is combining both these aspects.
...
In this paper the concepts described in~\cite{d2015pure, burnetas2013customer,
