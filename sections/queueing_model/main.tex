...
in ambulances that would not be at risk if they were blocked at the parking 
space) and type 1 individuals are individuals arriving from other sources 
...
% TODO: Explain why these performance measures are needed? (for the game)
