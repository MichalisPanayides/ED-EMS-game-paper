...
In order to consider this model numerically an adjustment needs 
to be made. 
...
\( \tilde S \subseteq S \) and there is a maximum allowed number of individuals \(N\) 
that can be in the system and a maximum allowed number of individuals \(M\) that can
