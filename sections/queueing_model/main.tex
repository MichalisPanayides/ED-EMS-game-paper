...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[>=stealth, scale=0.8],
        ...
        \node[anchor=north] at (5.15, 0.80 cm) {\small{\( T \)}};
...
% TODO: Decide whether to define type 1, 2 only in queueing section, only in game section, or both
Type 2 individuals are non-urgent patients arriving in ambulances (i.e. patients
in ambulances ).
...
that can wait in the hospital or for the ones that are blocked in the parking 
space. 
...
\(N\) that can be in the hospital and a maximum allowed number of individuals 
...
average number of patients at certain sets of state:
...
\begin{itemize}
    ...
    \item Average number of patients in the parking space:
