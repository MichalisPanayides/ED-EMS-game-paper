...
to them. 
The resultant model will then be used to explore dynamics between all players.
...
A 3-player game theoretic model is proposed between the two queueing systems
and the service that distributes individuals to them.
...
captures the emergent behaviour between, for example, the Emergency Medical 
...
\begin{keyword}
    Game theory \sep Queueing theory \sep OR in healthcare
\end{keyword}
