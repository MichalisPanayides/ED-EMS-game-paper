...
be used to help us find the Nash equilibrium of the game. 
The Nash equilibrium is the point of the game were both players have no 
...
The Lemke-Howson algorithm is used to get all Nash equilibria of the game 
\cite{LemkeHowson}.
Lemke-Howson uses best response polytopes to get one of the Nash equilibrium of
the game. 
By iterating over all possible dropped labels of the best response polytope all
Nash equilibria can be acquired.
