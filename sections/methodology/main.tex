...
on a strategy, at the same time, queueing system \(B\) chooses its own 
threshold, unaware of the first queueing system's choice.
...
Computation of Nash equilibria can be done relatively efficiently using the 
Lemke Howson algorithm~\cite{LemkeHowson}.
